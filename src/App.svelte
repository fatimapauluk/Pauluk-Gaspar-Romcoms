...
<header> 
  ...
  <div class="description-box">
    <p class="bajada">La comedia romántica (también conocida como rom-com) es un subgénero de comedia y ficción romántica, que se centra en líneas argumentales alegres y humorísticas centradas en ideas románticas, de cómo el amor verdadero es capaz de superar todos los obstáculos.</p>
  </div>
...
<!-- COLUMNA IZQUIERDA --> 
        ...
        <div class="graficolargo">
          <img src="./images/encuentro casual.png" alt="">
         </div>
...
<!-- COLUMNA IZQ --> 
      ...
      <div class="graficolargo">
        <img src="./images/nada es tan facil.png" alt="">
       </div>
...
<!-- COLUMNA IZQ --> 
        ...
        <div class="graficolargo">
          <img src="./images/emociones son fuertes.png" alt="">
         </div>
...
<section class="step_foreground revelacion">
  ...
  <div class="graficolargo">
    <img src="./images/siempre vuelven.png" alt="">
   </div>
    ...
    <div class="column">
      ...
      <!--<div class="graficotorta">
        <div class="cadagrafico">
          ...
          <p>Porcentaje en el que hay un <strong>final feliz</strong> [1].</p>
        </div>
        <div class="cadagrafico">
...
<div class="final">
  ...
  <div class="container">
    ...
    <div class="section">
        ...
        <img src="./images/WAFFLE.png" alt="DIRECTORES">
...
<div class="containerend">
  ...
  <img src="./images/theend.png" alt="Gif romántico">
</div>
